...
# generate inputs and targets
X_train, y_train = get_trials(input_patterns, target_patterns, training_trials, trial_steps)
X_test, y_test = get_trials(input_patterns, target_patterns, test_trials, trial_steps)
...
targets = np.reshape(np.asarray(y_test), (test_trials*trial_steps, n_out))
