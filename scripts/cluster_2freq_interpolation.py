...
# save results
results = {"targets": target_col, "predictions": prediction_col, "interpolation": interp_col,
           "k": k, "alpha": alpha, "repetition": rep}
pickle.dump(results, open(f"../results/2freq/k{int(k)}_alpha{int(alpha)}_{int(rep)}.pkl", "wb"))
